# TAVONEL signature hero

Truth class: T2 first-party designed brand object.

The complete hero family is generated from
`tools/assets/build_tavonel_hero.py` with Blender 4.5 LTS. It contains no
...
```powershell
& D:\CodexTools\blender-4.5.9\blender.exe --background --python tools\assets\build_tavonel_hero.py
