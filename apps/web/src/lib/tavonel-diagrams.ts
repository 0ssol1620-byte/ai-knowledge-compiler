export type TavonelDiagramDefinition = {
  id: string;
  title: string;
  question: string;
...
} as const satisfies Record<string, TavonelDiagramDefinition>;

export type TavonelDiagramId = keyof typeof TAVONEL_DIAGRAMS;

export const ROUTE_DIAGRAMS: Partial<Record<string, TavonelDiagramId>> = {
  "/product": "compiler",
