export type FolyntaDiagramDefinition = {
  id: string;
  title: string;
  question: string;
...
} as const satisfies Record<string, FolyntaDiagramDefinition>;

export type FolyntaDiagramId = keyof typeof FOLYNTA_DIAGRAMS;

export const ROUTE_DIAGRAMS: Partial<Record<string, FolyntaDiagramId>> = {
  "/product": "compiler",
