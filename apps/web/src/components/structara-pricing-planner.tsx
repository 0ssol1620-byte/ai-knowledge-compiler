...
export function StructaraPricingPlanner() {
  ...
  return (
    ...
    >
      <header>
        <p className="st-context-label">Plans and operating controls</p>
        <h2 id="pricing-plans-title">
          Choose the control surface, then size it.
        </h2>
        <div className="st-audience-switch" role="group" aria-label="Audience">
      ...
      <div className="st-credit-planner">
        <div>
          <p className="st-context-label">Transparent estimate</p>
