...
export function FolyntaOnboarding() {
  const [step, setStep] = useState(0);
  const [selected, setSelected] = useState<Record<string, string>>({});
  const current = steps[step]!;

  return (
    <main id="main-content" className="fl-onboarding">
      <header>
      ...
      <section>
        <div
          className="fl-onboarding-progress"
        ...
        <div className="fl-onboarding-copy">
          <p>{current}</p>
          <h1>
            {current === "Goal"
        ...
        <div className="fl-onboarding-options">
        ...
        <footer>
          ...
          {step < steps.length - 1 ? (
            ...
            <Link className="fl-app-primary" href="/quick-convert">
