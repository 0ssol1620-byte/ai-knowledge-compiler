...
export function TavonelAppPage({
  route,
  title,
  description,
  action,
  ...
  return (
    <div className="tv-app-page">
      <header className="tv-app-context">
        <div>
...
function HomeOverview() {
  return (
    <>
      <section className="tv-app-command">
        <div>
      ...
      />
      <section className="tv-app-split">
        ...
        <aside className="tv-app-panel tv-review-summary">
      ...
      <section className="tv-home-lower">
        <article>
          <PanelHeader
        ...
        <article>
          <PanelHeader
            ...
            href="/app/usage"
          />
          <strong className="tv-usage-number">
...
function ProjectsOverview({ route }: { route: string }) {
  ...
  return (
    <>
      <section className="tv-app-tools">
        <label>
        ...
        <div className="tv-view-switch" aria-label="Project view">
          <button
            type="button"
            aria-pressed="true"
            disabled
      ...
      />
      <section className="tv-app-panel tv-project-table">
        <PanelHeader
      ...
      {detail && (
        <section className="tv-project-health">
...
function SpecializedOverview({ route }: { route: string }) {
  ...
  return (
    <>
      <nav className="tv-feature-tabs" aria-label={`${route} sections`}>
...
function DocumentOverview({ route }: { route: string }) {
  ...
  if (view === "sources") {
    return (
      <>
        ...
        />
        <section className="tv-app-panel">
  ...
  if (view === "versions") {
    return (
      <section className="tv-app-panel tv-version-ledger">
        <PanelHeader
  ...
  return (
    <section className="tv-editor-layout">
      <aside>
        <span>Outline</span>
        {[
          "Executive summary",
      ...
      <article>
        ...
        <p className="tv-editor-kicker">Page 214 · paragraph 3 · User-edited</p>
      ...
      <aside className="tv-proof-panel">
        <span>Evidence</span>
...
function KnowledgeOverview() {
  return (
    <section className="tv-knowledge-layout">
      <aside className="tv-knowledge-nav">
...
function PolicyOverview({ route }: { route: string }) {
  ...
  return (
    <section className="tv-app-panel tv-policy-table">
      <PanelHeader
...
function MetricStrip({ values }: { values: readonly (readonly string[])[] }) {
  return (
    <section className="tv-app-metrics" aria-label="Workspace summary">
...
function AppTable({
  ...
  return (
    <div
      className="tv-data-table"
      role="table"
      aria-label="Data table"
      tabIndex={0}
    >
      <div role="row" className="tv-data-head">
        {headers.map((header) => (
