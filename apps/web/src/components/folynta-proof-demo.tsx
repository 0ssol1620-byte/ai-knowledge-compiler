...
export function FolyntaProofDemo() {
  ...
  return (
    <div className="fl-proof-demo">
      <div className="fl-proof-tabs" role="tablist" aria-label="DART demo view">
        {tabs.map((tab) => (
          <button
            key={tab}
            type="button"
      ...
      <div className="fl-proof-workspace">
        <div className="fl-proof-rail">
          <span>Report cover</span>
          <span>Financial statements</span>
          <strong>Income statement · Table</strong>
          <span>Notes</span>
        </div>
        <div className="fl-proof-source">
          <small>
          ...
          <div className="fl-source-table">
            ...
            {DART_PUBLIC_FIXTURE.rows.slice(0, 2).map((row, index) => (
              <div className="fl-source-table-row" key={row.label}>
                <span>{row.label}</span>
                <b
                  className={
                    index === 0 ? "fl-source-cell-selected" : undefined
                  }
                  aria-label={
                    index === 0
        ...
        <div className="fl-proof-result">
          <small>{view.eyebrow}</small>
          <h3>{view.title}</h3>
          <p>{view.statement}</p>
          {active === "Graph" && (
            <div
              className="fl-proof-mini-graph"
          ...
          <div className="fl-proof-evidence">
            <span>Source</span>
            <strong>
      ...
      <footer className="fl-proof-provenance">
