...
export function FolyntaPricingPlanner() {
  ...
  return (
    <section
      className="fl-pricing-system"
      aria-labelledby="pricing-plans-title"
    >
      <header>
        <p className="fl-context-label">Plans and operating controls</p>
        <h2 id="pricing-plans-title">
          Choose the control surface, then size it.
        </h2>
        <div className="fl-audience-switch" role="group" aria-label="Audience">
      ...
      <div className="fl-credit-planner">
        <div>
          <p className="fl-context-label">Transparent estimate</p>
          ...
          <label className="fl-planner-check">
            <input
              type="checkbox"
