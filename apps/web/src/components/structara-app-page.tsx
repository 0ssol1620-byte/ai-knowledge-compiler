...
function HomeOverview() {
  return (
    <>
      <section className="st-app-command">
        <div>
      ...
      />
      <section className="st-app-split">
        <div className="st-app-panel">
          <PanelHeader
            label="Active work"
      ...
      <section className="st-home-lower">
        <article>
          <PanelHeader
...
function ProjectsOverview({ route }: { route: string }) {
  ...
  return (
    <>
      <section className="st-app-tools">
        <label>
      ...
      />
      <section className="st-app-panel st-project-table">
        <PanelHeader
      ...
      {detail && (
        <section className="st-project-health">
...
function DocumentOverview({ route }: { route: string }) {
  ...
  if (view === "versions") {
    return (
      <section className="st-app-panel st-version-ledger">
        <PanelHeader
  ...
  return (
    <section className="st-editor-layout">
      <aside>
        <span>Outline</span>
        {[
          "Executive summary",
      ...
      <article>
        ...
        <p className="st-editor-kicker">Page 214 · paragraph 3 · User-edited</p>
      ...
      <aside className="st-proof-panel">
        <span>Evidence</span>
...
function KnowledgeOverview() {
  return (
    <section className="st-knowledge-layout">
      <aside className="st-knowledge-nav">
...
function PolicyOverview({ route }: { route: string }) {
  ...
  return (
    <section className="st-app-panel st-policy-table">
      <PanelHeader
...
function MetricStrip({ values }: { values: readonly (readonly string[])[] }) {
  return (
    <section className="st-app-metrics" aria-label="Workspace summary">
...
function AppTable({
  ...
  return (
    <div
      className="st-data-table"
      role="table"
      aria-label="Data table"
      tabIndex={0}
    >
      <div role="row" className="st-data-head">
        {headers.map((header) => (
