...
def _recovery_selection() -> dict[str, Any]:
    fixtures = (
        ("P01", RegionLevel.PAGE, PreprocessingVariant.PAGE_RERENDER_ALT_PARSER),
        ("B01", RegionLevel.REGION, PreprocessingVariant.REGION_CROP),
        ("T01", RegionLevel.ROW, PreprocessingVariant.OVERLAPPING_TILE),
        ("T02", RegionLevel.ROW, PreprocessingVariant.ROW_BAND_TILE),
        ("T03", RegionLevel.TABLE, PreprocessingVariant.CANDIDATE_REJECT),
        ("T04", RegionLevel.TABLE, PreprocessingVariant.TARGET_SELECTION),
        ("T05", RegionLevel.CELL, PreprocessingVariant.CELL_GEOMETRY),
        (
            "N01",
            RegionLevel.CELL,
            PreprocessingVariant.NATIVE_AUTHORITY_RECONSTRUCTION,
        ),
        ("N02", RegionLevel.CELL, PreprocessingVariant.CANONICAL_NUMERIC),
        ("R01", RegionLevel.REGION, PreprocessingVariant.LAYOUT_SPECIALIST),
        ("C01", RegionLevel.PAGE_PAIR, PreprocessingVariant.PAGE_PAIR_STITCH),
        ("F01", RegionLevel.REGION, PreprocessingVariant.FORMULA_SPECIALIST),
        ("G01", RegionLevel.REGION, PreprocessingVariant.SOURCE_REMAP),
        ("H01", RegionLevel.REGION, PreprocessingVariant.CANDIDATE_REJECT),
        ("H02", RegionLevel.REGION, PreprocessingVariant.CANDIDATE_REJECT),
        ("K01", RegionLevel.REGION, PreprocessingVariant.NOTE_RECOMPILE),
        ("K02", RegionLevel.REGION, PreprocessingVariant.ENTITY_SPLIT),
        ("K03", RegionLevel.REGION, PreprocessingVariant.RELATION_REMOVE),
    )
    outcomes = []
