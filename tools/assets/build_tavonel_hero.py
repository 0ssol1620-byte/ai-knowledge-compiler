"""Build the first-party TAVONEL Source-to-Knowledge hero master.

Run with Blender 4.5 LTS:
    blender --background --python tools/assets/build_tavonel_hero.py

The scene intentionally uses only procedural geometry, Blender's bundled font,
and the approved TAVONEL material palette. No external mesh, HDRI, texture,
...
print("TAVONEL hero master and derivatives created.")
